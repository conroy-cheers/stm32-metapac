...
# [inline (always)]
pub const fn clksel (& self) -> u8 { let val = (self . 0 >> 2usize) & 0x0f ; val as u8 } # [doc = "Reference clock frequency selection"]
# [inline (always)]
pub fn set_clksel (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x0f << 2usize)) | (((val as u32) & 0x0f) << 2usize) ; } } impl Default for Otghsphycr { # [inline (always)]
